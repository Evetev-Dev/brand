...
En la organización **EveTev** de GitHub → **New repository**
...
git branch -M main
git remote add origin https://github.com/EveTev/brand.git
...
```
https://cdn.jsdelivr.net/gh/EveTev/brand@1/isotipos/isotipo-azul-noche.svg
```
